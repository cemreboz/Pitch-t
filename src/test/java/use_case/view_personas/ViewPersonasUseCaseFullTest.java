 ...
 */
public class ViewPersonasUseCaseFullTest {
    ...
    @Test
    public void testExecute_withNullPitch() {
        // Arrange
        MockGptDataAccess mockGptDataAccess = new MockGptDataAccess();
        MockOutputBoundary mockOutputBoundary = new MockOutputBoundary();
        ViewPersonasInteractor interactor = new ViewPersonasInteractor(mockGptDataAccess, mockOutputBoundary);
        ...
        // Act
        interactor.execute(new ViewPersonasInputData(null));
    ...
    @Test
    public void testExecute_withIncompletePitch() {
        // Arrange
        Pitch pitch = new Pitch("p1", "", "", "", new ArrayList<>()); // Incomplete pitch details
        MockGptDataAccess mockGptDataAccess = new MockGptDataAccess();
        MockOutputBoundary mockOutputBoundary = new MockOutputBoundary();
        ViewPersonasInteractor interactor = new ViewPersonasInteractor(mockGptDataAccess, mockOutputBoundary);
        ...
        // Assert
        assertTrue(mockOutputBoundary.successCalled, "Success callback should have been called even with incomplete pitch.");
        assertNotNull(mockOutputBoundary.successData, "Output data should not be null.");
        assertTrue(mockOutputBoundary.successData.getPersonas().isEmpty(), "No personas should be generated for incomplete pitch.");
    }
}
